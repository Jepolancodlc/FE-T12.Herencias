...
namespace Ejercicio9
{
    class Peliculas
    {
        ...
        public Peliculas(string titulo, string director, double duracion, int edadMinima) //Devuelve valores aleatorios segun su tipo 
        {
        ...
        private int[] eMinima = { 0, 7, 12, 16, 18, 21 };
